  ...
  const cities = [
    {
      city: 'Delhi',
      image:
        'https://www.shutterstock.com/image-photo/view-on-india-gate-cloudy-600nw-2443149545.jpg',
    },
    {
      city: 'Hyderabad',
      image:
        'https://lp-cms-production.imgix.net/2019-06/GettyImages-171676147_full.jpg?fit=crop&ar=1%3A1&w=1200&auto=format&q=75',
    },
    {
      city: 'Bengaluru',
      image:
        'https://www.shutterstock.com/image-photo/bangalore-india-december-12-2024-600nw-2450403223.jpg',
    },
    {
      city: 'Chennai',
      image:
    ...
    },
    {
      city: 'Kota',
      image:
        'https://images.hindustantimes.com/rf/image_size_960x540/HT/p2/2017/05/24/Pictures/file-file-photo-photo-kota-city-ht_a3227bf2-407f-11e7-b7e5-3de2b6485255.jpg',
    },
  ];
  return (
